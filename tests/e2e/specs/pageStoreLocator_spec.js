describe('Store locator', () => {
  ...
  it('links to each category of the breadcrumb', () => {
    ...
    cy.visit('/product/havaianas-flipflops-brasil-grey/M0E20000000ELBX');
    cy.get('[data-test="product-original-price"]')
      .should('contain', '21,60');
    cy.get('[data-test="add-to-cart-button"]')
      .click();
    ...
    cy.visit('/stores');
    cy.get('[data-test="store-name"]')
      .should('contain', 'SUNRISE Store Berlin');
    cy.get('[data-test="unselect-store"]')
      .click();
