...
// // import ProductSortSelector from '@/components/productoverview/ProductSortSelector/ProductSortSelector.vue';
...
describe('ProductSortSelector/index.vue', () => {
  ...
  // });
  it('no idea what productsortselector is supposed to be', () => {
    expect(1).toBe(2);
  });
});
