<template>
  <div class="col-sm-12 nopadding">
    ...
    <div class="banner-text">
      ...
      <p class="hidden-xs hidden-sm">{{ $t('description') }}</p>
      <a class="btn banner-btn" href="/products/men-clothing-shirts">
        {{ $t('linkLabel') }}
      </a>
    </div>
  </div>
...
en:
  ...
  description: "Between rising temperature outside and cool A/C inside, dressing for the the
    summer can be a tricky business. Luckily, we pulled together the most inspiring looks for.
    Check out our must-to-have-it pieces. The weather is heating up, but you don’t have the right
...
de:
  title: "Here comes the sun"
  subtitle: "FABULOUS EVERY DAY - SUMMER CHIC"
  description: "Die Modetrends für den Sommer 2019 spielen mit Prints, Army- und Safarilooks
    ...
    Sommer 2019 vor. Lassen Sie sich inspirieren! Kaum ist der Frühling vorbei,
    ...
    New York, Mailand, Paris – SUNRISE präsentiert die aktuelle Sommermode 2019 aus den Modemetropolen.
